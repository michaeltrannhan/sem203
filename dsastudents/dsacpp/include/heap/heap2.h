    ...
    */
    ...
    void Heap<T>::remove(T item, void (*removeItemData)(T))
    {
        ...
        memmove(&elements[foundIdx], &elements[foundIdx+1], (copyCount) * sizeof(T));
        count--;
        int lastOld = count - 1;
        count = foundIdx;
        for (int i = foundIdx; i <= lastOld; i++)
        {
            push(elements[i]);
        }
    }
    ...
    void Heap<T>::reheapUp(int position)
    {
        ...
        if (aLTb(this->elements[position], this->elements[parent])) // comparator (a < b) > 0 then swap(if minheap)
        {
    ...
    void Heap<T>::reheapDown(int position)
    {
        ...
        // int big = leftChild;
        // if(rightChild < count && aLTb(elements[rightChild], elements[leftChild])){
        //     big = rightChild;
        // }
        // if(aLTb(elements[position], elements[big])<0){
        //     swap(big, position);
        //     reheapDown(big);
        // }
        ...
        // if (left < count)
        // {
        //     if (aLTb(elements[left], elements[position]))
        //         curr = left;
        // }
        // if (right < count)
        // {
        //     if (aLTb(elements[right], elements[curr]))
        //         curr = right;
        // }
        // if (curr != position)
        // {
